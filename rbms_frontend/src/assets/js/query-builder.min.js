...
!function(a, b) {
    ...
    $.extendext = function() {
        ...
        g = arguments[h++] || {}),
        "string" == typeof g && (k = g.toLowerCase(),
        "concat" !== k && "replace" !== k && "extend" !== k && (k = "default"),
        g = arguments[h++] || {}),
            ...
            if (null !== (a = arguments[h]))
                if ($.isArray(a) && "default" !== k)
                    ...
                    for (b in a)
                        ...
                        g[b] = $.extendext(j, k, f, d)) : void 0 !== d && (g[b] = d));
        return g
    }
}),
function() {
    ...
    function a(b, c, d) {
        return ("string" == typeof c ? c : c.toString()).replace(b.define || f, function(a, c, e, f) {
            return 0 === c.indexOf("def.") && (c = c.substring(4)),
            c in d || (":" === e ? (b.defineParams && f.replace(b.defineParams, function(a, b, e) {
                d[c] = {
                    arg: b,
                    text: e
                }
            ...
            b.useParams && (e = e.replace(b.useParams, function(a, b, c, e) {
                if (d[c] && d[c].arg && e) {
                    ...
                    return d.__exp = d.__exp || {},
                    d.__exp[f] = d[c].text.replace(new RegExp("(^|[^\\w$])" + d[c].arg + "([^\\w$])","g"), "$1" + e + "$2"),
                    b + "def.__exp['" + f + "']"
                }
            }));
    ...
    d.template = function(g, h, i) {
        ...
        n = ("var out='" + (h.strip ? n.replace(/(^|\r|\n)\t* +| +\t*(\r|\n|$)/g, " ").replace(/\r|\n|\t|\/\*[\s\S]*?\*\//g, "") : n).replace(/'|\\/g, "\\$&").replace(h.interpolate || f, function(a, c) {
            ...
            k = e || "i" + m,
            c = b(c),
            "';var arr" + m + "=" + c + ";if(arr" + m + "){var " + d + "," + k + "=-1,l" + m + "=arr" + m + ".length-1;while(" + k + "<l" + m + "){" + d + "=arr" + m + "[" + k + "+=1];out+='") : "';} } out+='"
        }).replace(h.evaluate || f, function(a, c) {
            return "';" + b(c) + "out+='"
        }) + "';return out;").replace(/\n/g, "\\n").replace(/\t/g, "\\t").replace(/\r/g, "\\r").replace(/(\s|;|\}|^|\{)out\+='';/g, "$1").replace(/\+''/g, ""),
        j && (h.selfcontained || !c || c._encodeHTML || (c._encodeHTML = d.encodeHTMLSource(h.doNotSkipEncoded)),
        n = "var encodeHTML = typeof _encodeHTML !== 'undefined' ? _encodeHTML : (" + d.encodeHTMLSource.toString() + "(" + (h.doNotSkipEncoded || "") + "));" + n);
        try {
...
function(a, b) {
    ...
    "use strict";
    function b(a) {
        return this instanceof b ? (this.root = null ,
        void (this.$ = $(this))) : b.getModel(a)
    }
    function c(a, b) {
    ...
    function d(a) {
        for (var b = Object.keys(a), c = 0, d = b.length; c < d; c++)
            if ("$or" == b[c].toLowerCase() || "$and" == b[c].toLowerCase())
                return b[c]
    }
    function e(a, c) {
        var d;
        return d = c.closest(h.rule_container),
        d.length ? void a.moveAfter(b(d)) : (d = c.closest(h.group_header),
        d.length ? (d = c.closest(h.group_container),
        void a.moveAtBegin(b(d))) : (d = c.closest(h.group_container),
        d.length ? void a.moveAtEnd(b(d)) : void 0))
    }
    function f(a) {
        var b = a.match(/(question_mark|numbered|named)(?:\((.)\))?/);
        return b || (b = [null , "question_mark", void 0]),
        b
    }
    var g = function(a, b) {
        this.init(a, b)
    ...
    $.extend(g.prototype, {
        change: function(a, b) {
            ...
            return this.$el.triggerHandler(c, Array.prototype.slice.call(arguments, 2)),
            c.value
        },
        trigger: function(a) {
            ...
            return this.$el.triggerHandler(b, Array.prototype.slice.call(arguments, 1)),
            b
        },
        on: function(a, b) {
            return this.$el.on(this.tojQueryEvent(a), b),
            this
        },
        off: function(a, b) {
            return this.$el.off(this.tojQueryEvent(a), b),
            this
        },
        once: function(a, b) {
            return this.$el.one(this.tojQueryEvent(a), b),
            this
        },
    ...
    g.prototype.initPlugins = function() {
        if (this.plugins) {
            ...
            Object.keys(this.plugins).forEach(function(a) {
                a in g.plugins ? (this.plugins[a] = $.extend(!0, {}, g.plugins[a].def, this.plugins[a] || {}),
                g.plugins[a].fct.call(this, this.plugins[a])) : l.error("Config", 'Unable to find plugin "{0}"', a)
            }, this)
        }
    }
    ,
    ...
    g.inputs = ["text", "textarea", "radio", "checkbox", "select"],
    g.modifiable_options = ["display_errors", "allow_groups", "allow_empty", "default_condition", "default_filter"];
    var h = g.selectors = {
    ...
    g.prototype.init = function(c, d) {
        c[0].queryBuilder = this,
        this.$el = c,
        this.settings = $.extendext(!0, "replace", {}, g.DEFAULTS, d),
        this.model = new b,
        this.status = {
            group_id: 0,
            rule_id: 0,
        ...
        this.settings.allow_groups === !1 ? this.settings.allow_groups = 0 : this.settings.allow_groups === !0 && (this.settings.allow_groups = -1),
        this.filters = this.settings.filters,
        this.icons = this.settings.icons,
        this.operators = this.settings.operators,
        this.templates = this.settings.templates,
        this.plugins = this.settings.plugins,
        void 0 === g.regional.en && l.error("Config", '"i18n/en.js" not loaded.'),
        this.lang = $.extendext(!0, "replace", {}, g.regional.en, g.regional[this.settings.lang_code], this.settings.lang),
        Object.keys(this.templates).forEach(function(b) {
            this.templates[b] || (this.templates[b] = g.templates[b]),
            "string" == typeof this.templates[b] && (this.templates[b] = a.template(this.templates[b]))
        }, this),
        this.$el.attr("id") || (this.$el.attr("id", "qb_" + Math.floor(99999 * Math.random())),
        ...
        d.rules ? (this.setRules(d.rules),
        delete this.settings.rules) : this.setRoot(!0)
    }
    ,
    g.prototype.checkFilters = function(a) {
      var b = [];
      if (a && 0 !== a.length || l.error("Config", "Missing filters list"),
      a.forEach(function(a, c) {
          switch (a.id || l.error("Config", "Missing filter {0} id", c),
          b.push(a.id),
          a.type ? g.types[a.type] || l.error("Config", 'Invalid type "{0}"', a.type) : a.type = "string",
          a.input ? "function" != typeof a.input && g.inputs.indexOf(a.input) == -1 && l.error("Config", 'Invalid input "{0}"', a.input) : a.input = "text",
          a.operators && a.operators.forEach(function(a) {
              "string" != typeof a && l.error("Config", "Filter operators must be global operators types (string)")
          }),
          a.field ,
          a.label ,
          a.optgroup ? (this.status.has_optgroup = !0,
          this.settings.optgroups[a.optgroup] || (this.settings.optgroups[a.optgroup] = a.optgroup)) : a.optgroup = null ,
          a.input) {
          case "radio":
          case "checkbox":
      ...
      this.settings.sort_filters)
          if ("function" == typeof this.settings.sort_filters)
              a.sort(this.settings.sort_filters);
          else {
              var c = this;
              a.sort(function(a, b) {
      ...
      return this.status.has_optgroup && (a = l.groupSort(a, "optgroup")),
      a
    ...
    g.prototype.checkOperators = function(a) {
        ...
        return a.forEach(function(c, d) {
            "string" == typeof c ? (g.OPERATORS[c] || l.error("Config", 'Unknown operator "{0}"', c),
            a[d] = c = $.extendext(!0, "replace", {}, g.OPERATORS[c])) : (c.type || l.error("Config", 'Missing "type" for operator {0}', d),
            g.OPERATORS[c.type] && (a[d] = c = $.extendext(!0, "replace", {}, g.OPERATORS[c.type], c)),
            void 0 !== c.nb_inputs && void 0 !== c.apply_to || l.error("Config", 'Missing "nb_inputs" and/or "apply_to" for operator "{0}"', c.type)),
            b.indexOf(c.type) != -1 && l.error("Config", 'Operator "{0}" already defined', c.type),
            b.push(c.type),
            c.optgroup ? (this.status.has_operator_optgroup = !0,
            this.settings.optgroups[c.optgroup] || (this.settings.optgroups[c.optgroup] = c.optgroup)) : c.optgroup = null
        }, this),
        this.status.has_operator_optgroup && (a = l.groupSort(a, "optgroup")),
        a
    }
    ,
    g.prototype.bindEvents = function() {
        ...
        this.model.on({
            drop: function(b, c) {
                c.$el.remove(),
                a.refreshGroupsConditions()
            },
            add: function(b, c, d) {
                0 === d ? c.$el.prependTo(c.parent.$el.find(">" + h.rules_list)) : c.$el.insertAfter(c.parent.rules[d - 1].$el),
                a.refreshGroupsConditions()
            },
            move: function(b, c, d, e) {
                c.$el.detach(),
                0 === e ? c.$el.prependTo(d.$el.find(">" + h.rules_list)) : c.$el.insertAfter(d.rules[e - 1].$el),
                a.refreshGroupsConditions()
            },
    ...
    g.prototype.setRoot = function(a, b, c) {
        ...
        this.model.root = new j(null ,e),
        this.model.root.model = this.model,
        this.model.root.data = b,
        this.model.root.flags = $.extend({}, this.settings.default_group_flags, c),
        this.trigger("afterAddGroup", this.model.root),
        this.model.root.condition = this.settings.default_condition,
        a && this.addRule(this.model.root),
        this.model.root
    }
    ,
    g.prototype.addGroup = function(a, b, c, d) {
        ...
        var g = this.nextGroupId()
          ...
          , i = a.addGroup(h);
        return i.data = c,
        i.flags = $.extend({}, this.settings.default_group_flags, d),
        this.trigger("afterAddGroup", i),
        i.condition = this.settings.default_condition,
        b && this.addRule(i),
        i
    }
    ,
    ...
    g.prototype.updateGroupCondition = function(a) {
        a.$el.find(">" + h.group_condition).each(function() {
            var b = $(this);
            b.prop("checked", b.val() === a.condition),
            b.parent().toggleClass("active", b.val() === a.condition)
        }),
    ...
    g.prototype.refreshGroupsConditions = function() {
        !function a(b) {
            (!b.flags || b.flags && !b.flags.condition_readonly) && b.$el.find(">" + h.group_condition).prop("disabled", b.rules.length <= 1).parent().toggleClass("disabled", b.rules.length <= 1),
            b.each(function(a) {}, function(b) {
                a(b)
            }, this)
        }(this.model.root)
    }
    ...
    g.prototype.addRule = function(a, b, c) {
        ...
        var e = this.nextRuleId()
          ...
          , g = a.addRule(f);
        return void 0 !== b && (g.data = b),
        g.flags = $.extend({}, this.settings.default_rule_flags, c),
        this.trigger("afterAddRule", g),
        this.createRuleFilters(g),
        !this.settings.default_filter && this.settings.display_empty_filter || (g.filter = this.change("getDefaultFilter", this.getFilterById(this.settings.default_filter || this.filters[0].id), g)),
        g
    }
    ,
    g.prototype.deleteRule = function(a) {
        ...
        return !b.isDefaultPrevented() && (a.drop(),
    ...
    g.prototype.createRuleFilters = function(a) {
        ...
        a.$el.find(h.filter_container).html(c),
        this.trigger("afterCreateRuleFilters", a)
    }
    ,
    g.prototype.createRuleOperators = function(a) {
        ...
        if (a.filter) {
            ...
            b.html(d),
            a.__.operator = c[0],
            this.trigger("afterCreateRuleOperators", a, c)
        }
    }
    ,
    g.prototype.createRuleInput = function(a) {
        var b = a.$el.find(h.value_container).empty();
        if (a.__.value = void 0,
        a.filter && a.operator && 0 !== a.operator.nb_inputs) {
            for (var c = this, d = $(), e = a.filter, f = 0; f < a.operator.nb_inputs; f++) {
                var g = $(this.getRuleInput(a, f));
                f > 0 && b.append(this.settings.inputs_separator),
                b.append(g),
                d = d.add(g)
            }
            b.show(),
            d.on("change " + (e.input_event || ""), function() {
                c.status.updating_value = !0,
                a.value = c.getRuleValue(a),
                c.status.updating_value = !1
            }),
            e.plugin && d[e.plugin](e.plugin_config || {}),
            this.trigger("afterCreateRuleInput", a),
            void 0 !== e.default_value ? a.value = e.default_value : (c.status.updating_value = !0,
            a.value = c.getRuleValue(a),
            c.status.updating_value = !1)
        }
    }
    ...
    g.prototype.updateRuleFilter = function(a, b) {
        this.createRuleOperators(a),
        this.createRuleInput(a),
        a.$el.find(h.rule_filter).val(a.filter ? a.filter.id : "-1"),
        b && a.filter && b.id !== a.filter.id && (a.data = void 0),
        this.trigger("afterUpdateRuleFilter", a)
    }
    ,
    g.prototype.updateRuleOperator = function(a, b) {
        var c = a.$el.find(h.value_container);
        a.operator && 0 !== a.operator.nb_inputs ? (c.show(),
        (c.is(":empty") || a.operator.nb_inputs !== b.nb_inputs) && this.createRuleInput(a)) : (c.hide(),
        a.__.value = void 0),
        a.operator && a.$el.find(h.rule_operator).val(a.operator.type),
        this.trigger("afterUpdateRuleOperator", a),
        this.updateRuleValue(a)
    }
    ,
    g.prototype.updateRuleValue = function(a) {
        this.status.updating_value || this.setRuleValue(a, a.value),
        this.trigger("afterUpdateRuleValue", a)
    }
    ,
    g.prototype.applyRuleFlags = function(a) {
        var b = a.flags;
        b.filter_readonly && a.$el.find(h.rule_filter).prop("disabled", !0),
        b.operator_readonly && a.$el.find(h.rule_operator).prop("disabled", !0),
        b.value_readonly && a.$el.find(h.rule_value).prop("disabled", !0),
        b.no_delete && a.$el.find(h.delete_rule).remove(),
        this.trigger("afterApplyRuleFlags", a)
    }
    ,
    g.prototype.applyGroupFlags = function(a) {
        var b = a.flags;
        b.condition_readonly && a.$el.find(">" + h.group_condition).prop("disabled", !0).parent().addClass("readonly"),
        b.no_add_rule && a.$el.find(h.add_rule).remove(),
        b.no_add_group && a.$el.find(h.add_group).remove(),
        b.no_delete && a.$el.find(h.delete_group).remove(),
        this.trigger("afterApplyGroupFlags", a)
    }
    ,
    g.prototype.clearErrors = function(a) {
        a = a || this.model.root,
        a && (a.error = null ,
        a instanceof j && a.each(function(a) {
            a.error = null
        }, function(a) {
            this.clearErrors(a)
        }, this))
    ...
    g.prototype.displayError = function(a) {
        if (this.settings.display_errors)
            if (null === a.error)
                ...
                b = l.fmt(b, a.error.slice(1)),
                b = this.change("displayError", b, a.error, a),
                a.$el.addClass("has-error").find(h.error_container).eq(0).attr("title", b)
            }
    }
    ,
    ...
    g.prototype.clear = function() {
        ...
        this.status.rule_id = 0,
        this.model.root && (this.model.root.drop(),
        ...
        var a = this
          , b = function c(b) {
            ...
            return b.each(function(b) {
                if (!b.filter)
                    return a.triggerValidationError(b, "no_filter", null ),
                    void e++;
                if (0 !== b.operator.nb_inputs) {
                    var c = a.validateValue(b, b.value);
                    if (c !== !0)
                        return a.triggerValidationError(b, c, b.value),
                        void e++
                }
                d++
            }, function(a) {
            ...
            !(e > 0) && (!!(0 !== d || a.settings.allow_empty && b.isRoot()) || (a.triggerValidationError(b, "empty_group", null ),
            !1))
        }(this.model.root);
    ...
    g.prototype.getRules = function(a) {
        ...
        var b = this
          , c = function d(c) {
            ...
            if (c.data && (e.data = $.extendext(!0, "replace", {}, c.data)),
            a.get_flags) {
            ...
            return c.each(function(c) {
                ...
                if ((c.filter.data || c.data) && (f.data = $.extendext(!0, "replace", {}, c.filter.data, c.data)),
                a.get_flags) {
                    var g = b.getRuleFlags(c.flags, "all" === a.get_flags);
                    $.isEmptyObject(g) || (f.flags = g)
                }
                e.rules.push(b.change("ruleToJson", f, c))
            }, function(a) {
                e.rules.push(d(a))
            }, this),
            b.change("groupToJson", e, c)
        }(this.model.root);
    ...
    g.prototype.setRules = function(a) {
        ...
        a && a.rules && (0 !== a.rules.length || this.settings.allow_empty) || l.error("RulesParse", "Incorrect data object passed"),
        this.clear(),
        this.setRoot(!1, a.data, this.parseGroupFlags(a)),
        a = this.change("setRules", a);
        var b = this;
        !function c(a, d) {
            null !== d && (void 0 === a.condition ? a.condition = b.settings.default_condition : b.settings.conditions.indexOf(a.condition) == -1 && l.error("UndefinedCondition", 'Invalid condition "{0}"', a.condition),
            d.condition = a.condition,
            a.rules.forEach(function(a) {
                var e;
                if (void 0 !== a.rules)
                    if (b.settings.allow_groups !== -1 && b.settings.allow_groups < d.level)
                        b.reset(),
                        l.error("RulesParse", "No more than {0} groups are allowed", b.settings.allow_groups);
                    else {
                        if (e = b.addGroup(d, !1, a.data, b.parseGroupFlags(a)),
                        null === e)
                            return;
                        c(a, e)
                    }
                else {
                    if (a.empty || (void 0 === a.id && l.error("RulesParse", "Missing rule field id"),
                    void 0 === a.operator && (a.operator = "equal")),
                    e = b.addRule(d, a.data),
                    null === e)
                        return;
                    a.empty || (e.filter = b.getFilterById(a.id),
                    e.operator = b.getOperatorByType(a.operator),
                    0 !== e.operator.nb_inputs && void 0 !== a.value && (e.value = a.value)),
                    e.flags = b.parseRuleFlags(a),
                    b.change("jsonToRule", e, a) != e && l.error("RulesParse", "Plugin tried to change rule reference")
                }
            }),
            b.change("jsonToGroup", d, a) != d && l.error("RulesParse", "Plugin tried to change group reference"))
        }(a, this.model.root)
    }
    ,
    g.prototype.validateValue = function(a, b) {
        var c = a.filter.validation || {}
          , d = !0;
        return d = c.callback ? c.callback.call(this, b, a) : this.validateValueInternal(a, b),
        this.change("validateValue", d, b, a)
    }
    ,
        ...
        for (var i = 0; i < e.nb_inputs; i++) {
            ...
            default:
                ...
                case "string":
                    ...
                    if (f.format && ("string" == typeof f.format && (f.format = new RegExp(f.format)),
                    !f.format.test(b[i]))) {
                ...
                case "datetime":
                    ...
                    break;
                case "boolean":
                    if (c = b[i].trim().toLowerCase(),
                    "true" !== c && "false" !== c && "1" !== c && "0" !== c && 1 !== b[i] && 0 !== b[i]) {
                        h = ["boolean_not_valid"];
                        break
                    }
                }
    ...
    g.prototype.getOperators = function(a) {
        ...
        for (var b = [], c = 0, d = this.operators.length; c < d; c++) {
            if (a.operators) {
                if (a.operators.indexOf(this.operators[c].type) == -1)
                    continue
            } else if (this.operators[c].apply_to.indexOf(g.types[a.type]) == -1)
                continue;b.push(this.operators[c])
        }
    ...
    g.prototype.getFilterById = function(a) {
        if ("-1" == a)
            return null ;
        for (var b = 0, c = this.filters.length; b < c; b++)
    ...
    g.prototype.getOperatorByType = function(a) {
        if ("-1" == a)
            return null ;
        for (var b = 0, c = this.operators.length; b < c; b++)
    ...
    g.prototype.getRuleValue = function(a) {
        ...
        if (b.valueGetter)
            ...
            for (var e = a.$el.find(h.value_container), f = 0; f < c.nb_inputs; f++) {
                ...
                case "checkbox":
                    g = [],
                    e.find("[name=" + i + "]:checked").each(function() {
                        g.push($(this).val())
                    }),
                    d.push(g);
                    break;
                case "select":
                    b.multiple ? (g = [],
                    e.find("[name=" + i + "] option:selected").each(function() {
                        g.push($(this).val())
                    }),
            ...
            1 === c.nb_inputs && (d = d[0]),
            b.valueParser && (d = b.valueParser.call(this, a, d))
        }
        ...
        if (c.valueSetter)
            ...
            for (var f = 0; f < d.nb_inputs; f++) {
                ...
                case "checkbox":
                    ...
                    break;
                default:
                    d.multiple && c.value_separator && $.isArray(b[f]) && (b[f] = b[f].join(c.value_separator)),
    ...
    g.prototype.parseRuleFlags = function(a) {
        ...
        a.flags && $.extend(b, a.flags),
        this.change("parseRuleFlags", b, a)
    }
    ,
    ...
    g.prototype.parseGroupFlags = function(a) {
        ...
        a.flags && $.extend(b, a.flags),
        this.change("parseGroupFlags", b, a)
    }
    ,
    ...
    g.prototype.getRuleInput = function(a, b) {
        var c = a.filter
          ...
          , h = "";
        if ("function" == typeof c.input)
            h = c.input.call(this, a, e);
        else
            switch (c.input) {
            case "radio":
            case "checkbox":
                ...
                break;
            case "select":
                h += '<select class="form-control" name="' + e + '"' + (c.multiple ? " multiple" : "") + ">",
                c.placeholder && (h += '<option value="' + c.placeholder_value + '" disabled selected>' + c.placeholder + "</option>"),
                l.iterateOptions(c.values, function(a, b) {
                ...
                break;
            case "textarea":
                h += '<textarea class="form-control" name="' + e + '"',
                c.size && (h += ' cols="' + c.size + '"'),
                c.rows && (h += ' rows="' + c.rows + '"'),
                void 0 !== d.min && (h += ' minlength="' + d.min + '"'),
                void 0 !== d.max && (h += ' maxlength="' + d.max + '"'),
            ...
            default:
                ...
                case "number":
                    h += '<input class="form-control" type="number" name="' + e + '"',
                    void 0 !== d.step && (h += ' step="' + d.step + '"'),
                    void 0 !== d.min && (h += ' min="' + d.min + '"'),
                    void 0 !== d.max && (h += ' max="' + d.max + '"'),
                    c.placeholder && (h += ' placeholder="' + c.placeholder + '"'),
                    c.size && (h += ' size="' + c.size + '"'),
                    h += ">";
                    break;
                default:
                    h += '<input class="form-control" type="text" name="' + e + '"',
                    c.placeholder && (h += ' placeholder="' + c.placeholder + '"'),
                    "string" === c.type && void 0 !== d.min && (h += ' minlength="' + d.min + '"'),
                    "string" === c.type && void 0 !== d.max && (h += ' maxlength="' + d.max + '"'),
                    c.size && (h += ' size="' + c.size + '"'),
                    h += "><i class='fa fa-search querybuilder-search'></i>"
                }
            }
    ...
    $.extend(b.prototype, {
        trigger: function(a) {
            return this.$.triggerHandler(a, Array.prototype.slice.call(arguments, 1)),
            this
        },
        on: function() {
        ...
        once: function() {
            return this.$.one.apply(this.$, Array.prototype.slice.call(arguments)),
            this
        }
    }),
        ...
        b.forEach(function(b) {
            Object.defineProperty(a.prototype, b, {
                ...
                set: function(a) {
                    ...
                    this.__[b] = a,
                    null !== this.model && this.model.trigger("update", this, b, a, c)
                }
            })
        })
    }
    ...
    var i = function(a, b) {
        ...
        this.id = b[0].id,
        this.model = null ,
        void (this.parent = a)) : new i
    }
    ;
    b.defineModelProperties(i, ["level", "error", "data", "flags"]),
    Object.defineProperty(i.prototype, "parent", {
        ...
        set: function(a) {
            this.__.parent = a,
            this.level = null === a ? 1 : a.level + 1,
            this.model = null === a ? null : a.model
        }
    }),
    ...
    i.prototype.drop = function() {
        var a = this.model;
        this.isRoot() || this.parent._removeNode(this),
        null !== a && a.trigger("drop", this)
    }
    ,
    i.prototype.moveAfter = function(a) {
        if (!this.isRoot())
            return this._move(a.parent, a.getPos() + 1),
            this
    }
    ,
    i.prototype.moveAtBegin = function(a) {
        if (!this.isRoot())
            return void 0 === a && (a = this.parent),
            this._move(a, 0),
            this
    }
    ,
    i.prototype.moveAtEnd = function(a) {
        if (!this.isRoot())
            return void 0 === a && (a = this.parent),
            this._move(a, 0 === a.length() ? 0 : a.length() - 1),
            this
    }
    ,
    i.prototype._move = function(a, b) {
        this.parent._removeNode(this),
        a._appendNode(this, b, !1),
        null !== this.model && this.model.trigger("move", this, a, b)
    }
    ;
    var j = function(a, b) {
        return this instanceof j ? (i.call(this, a, b),
        this.rules = [],
        void (this.__.condition = null )) : new j(a,b)
    }
    ;
    j.prototype = Object.create(i.prototype),
    j.prototype.constructor = j,
    b.defineModelProperties(j, ["condition"]),
    ...
    j.prototype._appendNode = function(a, b, c) {
        return void 0 === b && (b = this.length()),
        this.rules.splice(b, 0, a),
        a.parent = this,
        c && null !== this.model && this.model.trigger("add", a, b),
        a
    }
    ,
    ...
    j.prototype.each = function(a, b, c, d) {
        ...
        , i = !1; h() && (this.rules[e]instanceof j ? void 0 !== c && (i = c.call(d, this.rules[e]) === !1) : i = b.call(d, this.rules[e]) === !1,
        !i); e += g)
            ;
        return !i
    }
    ...
    ;
    var k = function(a, b) {
        return this instanceof k ? (i.call(this, a, b),
        this.__.filter = null ,
        this.__.operator = null ,
        this.__.flags = {},
        void (this.__.value = void 0)) : new k(a,b)
    }
    ;
    k.prototype = Object.create(i.prototype),
    k.prototype.constructor = k,
    b.defineModelProperties(k, ["filter", "operator", "value"]),
    g.Group = j,
    g.Rule = k;
    var l = g.utils = {};
    ...
    ,
    l.fmt = function(a, b) {
        return Array.isArray(b) || (b = Array.prototype.slice.call(arguments, 1)),
        a.replace(/{([0-9]+)}/g, function(a, c) {
            return b[parseInt(c)]
        })
    }
    ,
    l.error = function(a, b, c) {
        Array.isArray(c) || (c = Array.prototype.slice.call(arguments, 2));
        var d = new Error(l.fmt(b, c));
        throw d.name = a + "Error",
        d.args = c,
        d
    }
    ,
    ...
    l.groupSort = function(a, b) {
        ...
        return a.forEach(function(a) {
            var e;
            a[b] ? (e = c.lastIndexOf(a[b]),
            e == -1 ? e = c.length : e++) : e = c.length,
            c.splice(e, 0, a[b]),
            d.splice(e, 0, a)
        }),
        d
    ...
    $.fn.queryBuilder = function(a) {
        0 === this.length && l.error("Config", "No target defined"),
        this.length > 1 && l.error("Config", "Unable to initialize on multiple target");
        var b = this.data("queryBuilder")
          , c = "object" == typeof a && a || {};
        return b || "destroy" != a ? (b || this.data("queryBuilder", new g(this,c)),
        "string" == typeof a ? b[a].apply(b, Array.prototype.slice.call(arguments, 1)) : this) : this
    }
    ,
    $.fn.queryBuilder.constructor = g,
    $.fn.queryBuilder.defaults = g.defaults,
    $.fn.queryBuilder.extend = g.extend,
    $.fn.queryBuilder.define = g.define,
    $.fn.queryBuilder.regional = g.regional,
    g.define("bt-checkbox", function(a) {
        if ("glyphicons" == a.font) {
            var b = document.createElement("style");
            b.innerHTML = '.checkbox input[type=checkbox]:checked + label:after {     font-family: "Glyphicons Halflings";     content: "\\e013"; } .checkbox label:after {     padding-left: 4px;     padding-top: 2px;     font-size: 9px; }',
        ...
        this.on("getRuleInput.filter", function(b, c, d) {
            ...
            if (("radio" === e.input || "checkbox" === e.input) && !e.plugin) {
                b.value = "",
                e.colors || (e.colors = {}),
                e.color && (e.colors._def_ = e.color);
    ...
    g.define("bt-selectpicker", function(a) {
        $.fn.selectpicker && $.fn.selectpicker.Constructor || l.error("MissingLibrary", 'Bootstrap Select is required to use "bt-selectpicker" plugin. Get it here: http://silviomoreto.github.io/bootstrap-select'),
        this.on("afterCreateRuleFilters", function(b, c) {
    ...
    g.define("bt-tooltip-errors", function(a) {
        ...
        this.on("getRuleTemplate.filter getGroupTemplate.filter", function(a) {
            var b = $(a.value);
            b.find(h.error_container).attr("data-toggle", "tooltip"),
            a.value = b.prop("outerHTML")
        }),
    ...
    g.extend({
        setFilters: function(a, b) {
            ...
            void 0 === b && (b = a,
            a = !1),
            b = this.checkFilters(b),
            b = this.change("setFilters", b);
            ...
            function g(a) {
                a.each(!0, function(a) {
                    a.filter && d.indexOf(a.filter.id) === -1 ? a.drop() : (c.createRuleFilters(a),
                    a.$el.find(h.rule_filter).val(a.filter ? a.filter.id : "-1"),
                    c.trigger("afterUpdateRuleFilter", a))
                }, g)
            }(this.model.root),
            this.settings.plugins && (this.settings.plugins["unique-filter"] && this.updateDisabledFilters(),
            this.settings.plugins["bt-selectpicker"] && this.$el.find(h.rule_filter).selectpicker("render")),
        ...
        addFilter: function(a, b) {
            void 0 === b || "#end" == b ? b = this.filters.length : "#start" == b && (b = 0),
            $.isArray(a) || (a = [a]);
            ...
            parseInt(b) == b ? Array.prototype.splice.apply(c, [b, 0].concat(a)) : this.filters.some(function(a, c) {
                if (a.id == b)
                    return b = c + 1,
                    !0
            }) ? Array.prototype.splice.apply(c, [b, 0].concat(a)) : Array.prototype.push.apply(c, a),
            this.setFilters(c)
        },
    ...
    g.define("filter-description", function(a) {
        "inline" === a.mode ? this.on("afterUpdateRuleFilter", function(b, c) {
            ...
            c.filter && c.filter.description ? (0 === d.length ? (d = $('<p class="filter-description"></p>'),
            d.appendTo(c.$el)) : d.show(),
            d.html('<i class="' + a.icon + '"></i> ' + c.filter.description)) : d.hide()
        }) : "popover" === a.mode ? ($.fn.popover && $.fn.popover.Constructor && $.fn.popover.Constructor.prototype.fixTitle || l.error("MissingLibrary", 'Bootstrap Popover is required to use "filter-description" plugin. Get it here: http://getbootstrap.com'),
        this.on("afterUpdateRuleFilter", function(b, c) {
            var d = c.$el.find("button.filter-description");
            c.filter && c.filter.description ? (0 === d.length ? (d = $('<button type="button" class="btn btn-xs btn-info filter-description" data-toggle="popover"><i class="' + a.icon + '"></i></button>'),
            d.prependTo(c.$el.find(h.rule_actions)),
            d.popover({
                placement: "left",
                container: "body",
                html: !0
            ...
            d.data("bs.popover").options.content = c.filter.description,
            d.attr("aria-describedby") && d.popover("show")) : (d.hide(),
            d.data("bs.popover") && d.popover("hide"))
        })) : "bootbox" === a.mode && ("bootbox"in window || l.error("MissingLibrary", 'Bootbox is required to use "filter-description" plugin. Get it here: http://bootboxjs.com'),
        this.on("afterUpdateRuleFilter", function(b, c) {
            var d = c.$el.find("button.filter-description");
            c.filter && c.filter.description ? (0 === d.length && (d = $('<button type="button" class="btn btn-xs btn-info filter-description" data-toggle="bootbox"><i class="' + a.icon + '"></i></button>'),
            d.prependTo(c.$el.find(h.rule_actions)),
            d.on("click", function() {
    ...
    g.define("invert", function(a) {
        ...
        this.on("getGroupTemplate.filter", function(b, d) {
            var e = $(b.value);
            e.find(h.condition_container).after('<button type="button" class="btn btn-xs btn-primary" data-invert="group"><i class="' + a.icon + '"></i> ' + c.lang.invert + "</button>"),
            b.value = e.prop("outerHTML")
        }),
        a.display_rules_button && a.invert_rules && this.on("getRuleTemplate.filter", function(b) {
            var d = $(b.value);
            d.find(h.rule_actions).prepend('<button type="button" class="btn btn-xs btn-primary" data-invert="rule"><i class="' + a.icon + '"></i> ' + c.lang.invert + "</button>"),
            b.value = d.prop("outerHTML")
        })
    }, {
    ...
    g.extend({
        invert: function(a, b) {
            ...
            void 0 === b.recursive && (b.recursive = !0),
            void 0 === b.invert_rules && (b.invert_rules = !0),
            void 0 === b.silent_fail && (b.silent_fail = !1),
            void 0 === b.trigger && (b.trigger = !0),
            a instanceof j) {
                if (this.settings.conditionOpposites[a.condition] ? a.condition = this.settings.conditionOpposites[a.condition] : b.silent_fail || l.error("InvertCondition", 'Unknown inverse of condition "{0}"', a.condition),
                b.recursive) {
                    var c = $.extend({}, b, {
                        trigger: !1
                    });
                ...
                if (this.settings.operatorOpposites[a.operator.type]) {
                    ...
                    b.silent_fail || l.error("InvertOperator", 'Unknown inverse of operator "{0}"', a.operator.type);
    ...
    g.extend({
        getMongo: function(a) {
            ...
            var b = this;
            return function c(a) {
                if (a.condition || (a.condition = b.settings.default_condition),
                ["AND", "OR"].indexOf(a.condition.toUpperCase()) === -1 && l.error("UndefinedMongoCondition", 'Unable to build MongoDB query with condition "{0}"', a.condition),
                !a.rules)
                    return {};
                var d = [];
                a.rules.forEach(function(a) {
                    if (a.rules && a.rules.length > 0)
                        ...
                        var e = b.settings.mongoOperators[a.operator]
                          ...
                          , g = [];
                        void 0 === e && l.error("UndefinedMongoOperator", 'Unknown MongoDB operation for operator "{0}"', a.operator),
                        0 !== f.nb_inputs && (a.value instanceof Array || (a.value = [a.value]),
                        a.value.forEach(function(b) {
                            g.push(l.changeType(b, a.type, !1))
                        }));
                        var h = {}
                          , i = b.change("getMongoDBField", a.field, a);
                        h[i] = e.call(b, g),
                        d.push(b.change("ruleToMongo", h, a))
                    }
                });
                var e = {};
                return e["$" + a.condition.toLowerCase()] = d,
                b.change("groupToMongo", e, a)
            }(a)
        },
        getRulesFromMongo: function(a) {
            if (void 0 === a || null === a)
                return null ;
            var b = this;
            if (a = b.change("parseMongoNode", a),
            "rules"in a && "condition"in a)
                return a;
            var e = d(a);
            ...
            function f(a, e) {
                ...
                return g.forEach(function(a) {
                    ...
                    if ("id"in a && "operator"in a && "value"in a)
                        return void h.push(a);
                    var e = d(a);
                    if (e)
                        h.push(f(a, e));
    ...
    h.group_not = h.group_header + " [data-not=group]",
    b.defineModelProperties(j, ["not"]),
    g.define("not-group", function(a) {
        ...
        this.on("getGroupTemplate.filter", function(b, d) {
            var e = $(b.value);
            e.find(h.condition_container).prepend('<button type="button" class="btn btn-xs btn-primary" data-not="group"><i class="' + a.icon_unchecked + '"></i> ' + c.lang.NOT + "</button>"),
            b.value = e.prop("outerHTML")
        }),
        ...
        this.on("parseSQLNode.filter", function(a) {
            a.value.name && "NOT" == a.value.name.toUpperCase() && (a.value = a.value.arguments.value[0],
            a.value.not = !0)
        }),
    ...
    g.extend({
        updateGroupNot: function(a) {
            ...
            a.$el.find(">" + h.group_not).toggleClass("active", a.not).find("i").attr("class", a.not ? b.icon_checked : b.icon_unchecked),
            this.trigger("afterUpdateGroupNot", a)
        }
    }),
    h.rule_and_group_containers = h.rule_container + ", " + h.group_container,
    h.drag_handle = ".drag-handle",
    g.define("sortable", function(a) {
        "interact"in window || l.error("MissingLibrary", 'interact.js is required to use "sortable" plugin. Get it here: http://interactjs.io'),
        interact.dynamicDrop(!0),
        interact.pointerMoveTolerance(10);
        var c, d, f;
        this.on("afterAddRule afterAddGroup", function(a, g) {
            g != c && (interact(g.$el[0]).allowFrom(h.drag_handle).draggable({
                onstart: function(a) {
                    f = b(a.target),
                    d = f.$el.clone().appendTo(f.$el.parent()).width(f.$el.outerWidth()).addClass("dragging");
                    var e = $('<div class="rule-placeholder">&nbsp;</div>').height(f.$el.outerHeight());
                    c = f.parent.addRule(e, f.getPos()),
                    f.$el.hide()
                },
                onmove: function(a) {
                    d[0].style.top = a.clientY - 15 + "px",
                    d[0].style.left = a.clientX - 15 + "px"
                },
                onend: function(a) {
                    d.remove(),
                    d = void 0,
            ...
            g instanceof j && interact(g.$el.find(h.group_header)[0]).dropzone({
                accept: h.rule_and_group_containers,
                ondragenter: function(a) {
                    e(c, $(a.target))
                },
        ...
        this.on("beforeDeleteRule beforeDeleteGroup", function(a, b) {
            a.isDefaultPrevented() || (interact(b.$el[0]).unset(),
            b instanceof j && interact(b.$el.find(h.group_header)[0]).unset())
        }),
        ...
        this.on("getGroupTemplate.filter", function(b, c) {
            if (c > 1) {
                var d = $(b.value);
                d.find(h.condition_container).after('<div class="drag-handle"><i class="' + a.icon + '"></i></div>'),
                b.value = d.prop("outerHTML")
            }
        }),
        this.on("getRuleTemplate.filter", function(b) {
            var c = $(b.value);
            c.find(h.rule_header).after('<div class="drag-handle"><i class="' + a.icon + '"></i></div>'),
            b.value = c.prop("outerHTML")
        })
    }, {
    ...
    g.extend({
        getSQL: function(a, b, c) {
            ...
            var e = this
              , g = function h(c) {
                ...
                ["AND", "OR"].indexOf(c.condition.toUpperCase()) === -1 && l.error("UndefinedSQLCondition", 'Unable to build SQL query with condition "{0}"', c.condition),
                !c.rules)
                    return "";
                var d = [];
                c.rules.forEach(function(c) {
                    if (c.rules && c.rules.length > 0)
                        ...
                        var f = e.settings.sqlOperators[c.operator]
                          ...
                          , i = "";
                        void 0 === f && l.error("UndefinedSQLOperator", 'Unknown SQL operation for operator "{0}"', c.operator),
                        0 !== g.nb_inputs && (c.value instanceof Array || (c.value = [c.value]),
                        c.value.forEach(function(b, d) {
                            d > 0 && (i += f.sep),
                            "integer" == c.type || "double" == c.type || "boolean" == c.type ? b = l.changeType(b, c.type, !0) : a || (b = l.escapeString(b)),
                            f.mod && (b = l.fmt(f.mod, b)),
                            a ? i += a.add(c, b) : ("string" == typeof b && (b = "'" + b + "'"),
                            i += b)
                        }));
                        var j = e.change("getSQLField", c.field, c) + " " + f.op.replace(/\?/, i);
                        d.push(e.change("ruleToSQL", j, c))
                    }
                });
        ...
        getRulesFromSQL: function(a, b) {
            ...
            b && (a.sql = b.esc(a.sql)),
            0 !== a.sql.toUpperCase().indexOf("SELECT") && (a.sql = "SELECT * FROM table WHERE " + a.sql);
            var e = SQLParser.parse(a.sql);
            if (e.where || l.error("SQLParse", "No WHERE clause found"),
            a = c.change("parseSQLNode", e.where.conditions),
            "rules"in a && "condition"in a)
                return a;
            ...
            return function i(a, d) {
                if (a = c.change("parseSQLNode", a),
                "rules"in a && "condition"in a)
                    return void h.rules.push(a);
                if ("id"in a && "operator"in a && "value"in a)
                    return void h.rules.push(a);
                if ("left"in a && "right"in a && "operation"in a || l.error("SQLParse", "Unable to parse WHERE clause"),
                ["AND", "OR"].indexOf(a.operation.toUpperCase()) !== -1) {
                    ...
                    h.condition = a.operation.toUpperCase(),
                    d++;
                    var f = h;
                    i(a.left, d),
                    h = f,
                    ...
                    void 0 !== a.left.value && void 0 !== a.right.value || l.error("SQLParse", "Missing field and/or value"),
                    ...
                    b && (g = $.isArray(g) ? g.map(b.parse) : b.parse(g));
    ...
    g.define("unique-filter", function() {
        ...
        this.on("getDefaultFilter.filter", function(a, b) {
            var c = a.builder;
            if (c.updateDisabledFilters(),
            a.value.id in c.status.used_filters) {
                var d = c.filters.some(function(d) {
                    if (!(d.id in c.status.used_filters) || c.status.used_filters[d.id].length > 0 && c.status.used_filters[d.id].indexOf(b.parent) === -1)
                        return a.value = d,
                        !0
                });
                d || (l.error("UniqueFilter", "No more non-unique filters available"),
                a.value = void 0)
            }
        })
    }),
    g.extend({
        updateDisabledFilters: function(a) {
            ...
            b.status.used_filters = {},
            b.model && (!function c(a) {
                a.each(function(a) {
                    a.filter && a.filter.unique && (b.status.used_filters[a.filter.id] || (b.status.used_filters[a.filter.id] = []),
                    "group" == a.filter.unique && b.status.used_filters[a.filter.id].push(a.parent))
                }, function(a) {
                    c(a)
                })
            }(b.model.root),
            b.applyDisabledFilters(a))
        },
        ...
        applyDisabledFilters: function(a) {
            var b = a ? a.builder : this;
            b.$el.find(h.filter_container + " option").prop("disabled", !1),
            $.each(b.status.used_filters, function(a, c) {
